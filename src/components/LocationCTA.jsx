  ...
  return (
    <section id="lokatsia" className="px-4 sm:px-6 py-20 sm:py-28 bg-surface2 border-b border-ink/8">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        <div className="bg-surface rounded-2xl shadow-md shadow-ink/5 p-8 flex flex-col">
          <div>
          ...
          <div className="relative rounded-xl overflow-hidden border border-ink/10 mt-6 h-48 sm:h-56">
            <iframe
              src={MAPS_EMBED_URL}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute top-3 left-3 inline-flex items-center gap-2 rounded-full bg-surface/95 backdrop-blur px-3 py-1.5 text-xs font-medium shadow-md shadow-ink/10 hover:bg-surface transition-colors"
            >
